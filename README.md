...
このアプリ開発では**未だ触ったことのない機能や技術を取り入れることに積極的に挑んでまいりました**。その例として、dockerを導入し誰でもdockerイメージを共有可能にし、ActionCableを使用したWebSocket通信を使ったメッセージ機能など、知識が0だった新たな技術も多く取り入れてまいりました。その中で生まれるチームワークや多くのスキルアップが表れるようなアプリになっておりますので、紹介してまいりたいと思います。
<br>
...
本アプリはインスタグラムのようなSNSアプリケーションです。
写真投稿や動画投稿・コメント・いいねなどを通してあったことを皆で共有でき、ダイレクトメッセージでは一人一人と会話が可能。
おすすめページではいいねの多い投稿が見れます。
<br><br>
